...
//                                 { headerName: "Transcription", field: "metadata.transcription_text", sortable: true, width: 200, },
//                             ]}
                    ...
                    <div className={"w-full h-[760px] p-4 ag-theme-alpine-dark"}>
                        <AgGridReact
                            ...
                            columnDefs={[
                                ...
                                { headerName: "Created", field: "createdAt", sortable: true, filter: true, cellRenderer: DateFromNowRenderer, width: 120 },
                                { headerName: "Received", field: "receivedAt", sortable: true, filter: true, cellRenderer: DateFromNowRenderer, width: 120 },
                                // Conditionally add "Transcription" column based on the presence of metadata
                                ...(files.some((file: any) => file.metadata) ? [
                                    { headerName: "Transcription", field: "metadata.transcription_text", width: 300 }
                                ] : [])
                            ]}
